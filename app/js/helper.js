...
function check_time(begin, end, current) {
    [begin_hours, begin_minutes] = begin.split(':');
    begin_hours *= 60;
    begin_minutes_combined = begin_hours + begin_minutes;
    console.log(begin_minutes_combined);
}
...
function list_free_rooms(all_rooms, room, current_time) {
    ...
    lectures.forEach(lecture => {
        console.log(lecture.begin);
        check_time(lecture.begin, lecture.end, 'lol');
    });
